...
function MibiAnalysis3(pointNumber, fileNameXML, fileNameMass, processedDataDir, dataDir, spectraVec, depthStart, depthEnd, depthProfile, chemicalImage, processMsdf, calibrateSpectra, First, removeChannels, extractSpectraParams, makePlots, fixRasterRows, fixRasterCols, calibrateSpectraPerDepth, sumDepths, coregister_planes, CRchannel, filterNoise, plotCorrelations, saveTifsNoNoise, saveTifs, badDepths)
